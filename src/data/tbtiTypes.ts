...
export const questions: Question[] = [
  // EC 路线偏好维度 (3题) - 探险型 vs 经典型
  {
    id: 1,
    dimension: "EC",
    text: "【神秘园风格题】你们队在武功山草甸上迷路了，天色渐暗，气温骤降，两步路APP显示前面有条没标记的野径（可能是神秘园下一期的素材），你会：",
    options: [
      { text: "走！恐惧是生物的本能，勇气是人类的赞歌！无装备速穿才是真谛", value: "E1" },
      { text: "原地等救援，打开卫星电话SOS，这是神秘园教我的求生法则", value: "C1" },
      { text: "先派一个人探路——反正不是我，安全了全队再走", value: "C2" },
      { text: "打开六只脚看看有没有轨迹，没有就不冒险，我不想上神秘园", value: "C3" }
    ]
  },
  {
    id: 2,
    dimension: "EC",
    text: "朋友约你去鳌太线（中国最难徒步线之一，神秘园重点关照对象），说「据说最近能走，网上有人刚穿越完」，你会：",
    options: [
      { text: "立刻买机票！鳌太线是人生必走清单，死了都要去，大不了上神秘园", value: "E2" },
      { text: "先查中国登山协会有没有发禁入公告，我不想成为神秘园第301期主角", value: "C4" },
      { text: "等官方开放季节，找专业向导带队，拒绝成为素材", value: "C5" },
      { text: "去什么鳌太，隔壁成熟的太白山南线不香吗，活着不好吗", value: "C6" }
    ]
  },
  {
    id: 3,
    dimension: "EC",
    text: "在贡嘎雪山徒步时，你们发现一条冰川裂缝上的「近路」，能省2小时但有点危险（神秘园警告：冰川裂缝是户外十大杀手之一）：",
    options: [
      { text: "冲！省下的2小时可以在营地多拍日照金山，大不了让队友拍遗照", value: "E3" },
      { text: "绕远路，冰川裂缝不是开玩笑的，我不想上神秘园", value: "C7" },
